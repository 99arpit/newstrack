      ...
      case 1:
        return (
          <div className="formcontainer">
            <p style={{ fontFamily: "Rooboto" }} className="vendortext">
              PUBLISHER DETAILS
            </p>
            <div className="vendorformbox">
              <div className="vendorformbox1">
                <TextField
                  style={{ fontFamily: "Roobotot" }}
                  id="standard-basic"
                ...
                <FormControl fullWidth>
                  ...
                  >
                    <option
                      ...
                      value={"None"}
                    ></option>
                    <option style={{ fontFamily: "Rooboto" }} value={"Daily"}>
                      DAILY
                    </option>
                    <option style={{ fontFamily: "Rooboto" }} value={"Weekly"}>
                      WEEKLY
                    </option>
                    <option style={{ fontFamily: "Rooboto" }} value={"Monthly"}>
                      MONTHLY
                    </option>
                    <option
                      style={{ fontFamily: "Rooboto" }}
                    ...
                    <option style={{ fontFamily: "Rooboto" }} value={"Yearly"}>
                      YEARLY
                    </option>
                    <option
                      style={{ fontFamily: "Rooboto" }}
                ...
                <FormControl fullWidth>
                  ...
                  >
                    ...
                    <option
                      ...
                      value={"None"}
                    ></option>
                    <option style={{ fontFamily: "Rooboto" }} value={"Active"}>
                      ACTIVE
                    </option>
                    <option
                      style={{ fontFamily: "Rooboto" }}
